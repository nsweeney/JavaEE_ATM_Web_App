...
/**
 * Generates a unique id across the system. Accounts for multiple instances
 * across the system.
 * 
 * @version 1.0
 */
public class SystemIdGenerator
{
	...
	/**
	 * This is a singleton factory method. The constructor is made private so
	 * the only way to get a SystemIdGenerator is to use this method.
	 * 
	...
	/**
	 * Default constructor This constructor is hidden and only the public
	 * factory is available getInstance()
	 */
	...
	/**
	 * Performs the id increment and updates the internal list
	 * 
	 * @return next ID.
	 */
