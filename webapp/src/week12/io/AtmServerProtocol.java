...
public class AtmServerProtocol
{
	...
	public String process(String msg)
	{
		...
		if(msgCallback == msg_OK)
		{
			...
			String response = "<login-response version=\"1.0\" logged-in=\"true\" session-id=\""
	...
	/**
	 * Adds an account id to the hash table returns false if the nick is already
	 * in the table, true otherwise
	 */
