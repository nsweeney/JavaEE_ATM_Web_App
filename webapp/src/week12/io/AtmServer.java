...
public class AtmServer
{
	 ...
	 * accept() blocks until a client requests a connection. At that point the
	 * method returns and assigns a Socket instance to the client variable. This
	 * client instance is then wrapped in the ClientConn object which handles
	 * the communications between client and the server. A thread is used to
	 * handle this communication The listener goes back and listens for another
	 * client.
	 * 
	 */
